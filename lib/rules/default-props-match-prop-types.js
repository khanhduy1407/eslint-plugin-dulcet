  ...
  create: Components.detect(function(context, components, utils) {
    ...
    return {
      MemberExpression: function(node) {
        ...
        //   foo: Dulcet.PropTypes.string.isRequired,
        //   bar: Dulcet.PropTypes.string
        // };
        //
        // or:
        //
        ...
        // e.g.:
        // MyComponent.propTypes.baz = Dulcet.PropTypes.string;
      ...
      // e.g.:
      // class Hello extends Dulcet.Component {
      //   static get propTypes() {
      //     return {
      //       name: Dulcet.PropTypes.string
      //     };
      //   }
      ...
      // e.g.:
      // class Greeting extends Dulcet.Component {
      //   render() {
      //     return (
      ...
      //   }
      //   static propTypes = {
      //     foo: Dulcet.PropTypes.string,
      //     bar: Dulcet.PropTypes.string.isRequired
      //   };
      // }
