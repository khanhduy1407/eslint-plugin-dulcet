/**
 * @fileoverview Enforce Dulcet components to have a shouldComponentUpdate method
 * @author NKDuy
 */
'use strict';
...
module.exports = {
  meta: {
    docs: {
      description: 'Enforce Dulcet components to have a shouldComponentUpdate method',
  ...
  create: Components.detect(function (context, components, utils) {
    ...
    /**
     * Checks to see if our component is decorated by PureRenderMixin via dulcetMixin
      ...
      if (node.decorators && node.decorators.length) {
        for (var i = 0, l = node.decorators.length; i < l; i++) {
          if (
            ...
            node.decorators[i].expression.callee.object.name === 'dulcetMixin' &&
