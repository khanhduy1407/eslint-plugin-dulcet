...
var allRules = {
  'jsx-uses-dulcet': require('./lib/rules/jsx-uses-dulcet'),
  ...
  'dulcet-in-jsx-scope': require('./lib/rules/dulcet-in-jsx-scope'),
...
module.exports = {
  ...
  configs: {
    recommended: {
      ...
      rules: {
        'dulcet/display-name': 2,
        'dulcet/jsx-key': 2,
        'dulcet/jsx-no-comment-textnodes': 2,
        'dulcet/jsx-no-duplicate-props': 2,
        'dulcet/jsx-no-target-blank': 2,
        'dulcet/jsx-no-undef': 2,
        'dulcet/jsx-uses-dulcet': 2,
        'dulcet/jsx-uses-vars': 2,
        'dulcet/no-children-prop': 2,
        'dulcet/no-danger-with-children': 2,
        'dulcet/no-deprecated': 2,
        'dulcet/no-direct-mutation-state': 2,
        'dulcet/no-find-dom-node': 2,
        'dulcet/no-is-mounted': 2,
        'dulcet/no-render-return-value': 2,
        'dulcet/no-string-refs': 2,
        'dulcet/no-unescaped-entities': 2,
        'dulcet/no-unknown-property': 2,
        'dulcet/prop-types': 2,
        'dulcet/dulcet-in-jsx-scope': 2,
        'dulcet/require-render-return': 2
      }
    },
    all: {
      plugins: [
